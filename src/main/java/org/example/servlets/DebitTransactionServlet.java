...
public class DebitTransactionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int value = transactionService.debitTransaction(jsonRequest.getInt("value"),
    ...
    private JSONObject getJSONObject(int val) {
        ...
        switch (val) {
            case 1 -> jsonObject.put("message", "identifier is not unique");
            case 2 -> jsonObject.put("message", "debit amount exceeds balance");
            default -> jsonObject.put("message", "operation completed successfully");
        }
        return jsonObject;
    }
